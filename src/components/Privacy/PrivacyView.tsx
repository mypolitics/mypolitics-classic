    ...
    return (
        <main className="privacy">
            ...
            <section className="privacy__content">
                ...
                <ol>
                    <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>mypolitics.orlow.me</b></li>
                    ...
                    <ul><li>Obsługa zapytań przez formularz</li>
                    </ul>
                ...
                <ol><li>Miejsca logowania i wprowadzania danych osobowych są chronione w warstwie transmisji (certyfikat SSL). Dzięki temu dane osobowe i dane logowania, wprowadzone na stronie, zostają zaszyfrowane w komputerze użytkownika i mogą być odczytane jedynie na docelowym serwerze.</li><li>Istotnym elementem ochrony danych jest regularna aktualizacja wszelkiego oprogramowania, wykorzystywanego przez Operatora do przetwarzania danych osobowych, co w szczególności oznacza regularne aktualizacje komponentów programistycznych.</li>
                </ol>
                <h2>3. Hosting</h2>
                <ol>
